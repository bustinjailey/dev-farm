...
// Development: parent of dashboard directory (repo root)
export const HOST_REPO_PATH = process.env.HOST_REPO_PATH || (IS_PRODUCTION ? '/opt/dev-farm' : path.resolve(process.cwd(), '..'));
...
export const FARM_CONFIG_FILE = `${HOST_REPO_PATH}/farm-config.json`;
